...
QT_MOC_LITERAL(9, 91, 11) // "fileContent"

    },
    "FileHelper\0filenameChanged\0\0"
    "fileContentChanged\0saveFile\0loadFile\0"
    "getFilename\0name\0filename\0fileContent"
};
...
void FileHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { QString _r = _t->getFilename((*reinterpret_cast< const QString(*)>(_a[1])));
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileHelper::filenameChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (FileHelper::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileHelper::fileContentChanged)) {
                *result = 1;
                return;
            }
        }
